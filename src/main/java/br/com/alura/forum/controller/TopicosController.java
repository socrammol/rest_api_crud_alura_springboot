...
public class TopicosController {
	...
	public Page<TopicoDto> lista(@RequestParam(required = false) String nomeCurso, @RequestParam int pagina,
		...
		Pageable paginacao = PageRequest.of(pagina, qtp, Direction.ASC, ordenacao);
		if (nomeCurso == null) {
	...
	@PostMapping
	@Transactional
	public ResponseEntity<TopicoDto> cadastrar(@RequestBody TopicoForm form, UriComponentsBuilder uriBilder) {
